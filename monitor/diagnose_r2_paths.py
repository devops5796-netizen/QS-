...
=====================
Quick standalone check: what actually exists under qatarsale/year=.../month=.../day=.../
...
Usage:
    python diagnose_r2_paths.py --prefix qatarsale --date 2026-08-02
    python diagnose_r2_paths.py --prefix qatarsale --days 5   # scans last 5 days
"""
...
def list_immediate_children(client, bucket, prefix):
    ...
    for page in paginator.paginate(Bucket=bucket, Prefix=prefix, Delimiter="/"):
        for cp in page.get("CommonPrefixes", []):
            # cp["Prefix"] looks like "qatarsale/year=2026/month=08/day=02/Vehicles/"
...
def main():
    ...
    parser.add_argument("--prefix", default="qatarsale")
